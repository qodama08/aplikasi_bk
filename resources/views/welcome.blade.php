    ...
    <body class="landing-page">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-sm-6 col-lg-4">
                        <div class="card wow fadeInUp" data-wow-delay="0.4s">
                            <div class="card-body">
                                <img src="../assets/images/landing/img-feature1.svg" alt="img"
                                    class="img-fluid">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card wow fadeInUp" data-wow-delay="0.6s">
                            <div class="card-body">
                                <img src="../assets/images/landing/img-feature2.svg" alt="img"
                                    class="img-fluid">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card wow fadeInUp" data-wow-delay="0.8s">
                            <div class="card-body">
                                <img src="../assets/images/landing/img-feature3.svg" alt="img"
                                    class="img-fluid">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-sm-6 col-lg-4">
                        <div class="card wow fadeInUp" data-wow-delay="0.4s">
                            <div class="card-body">
                                ...
                                <button class="btn btn-outline-primary">Preview Figma <i
                                        class="ti ti-brand-figma"></i></button>
                            </div>
                            <div class="card-body pb-0 pe-0">
                                <img src="../assets/images/landing/img-demo1.jpg" alt="img"
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card wow fadeInUp" data-wow-delay="0.6s">
                            ...
                            <div class="card-body bg-light-primary pb-0 pe-0">
                                <img src="../assets/images/landing/img-demo2.jpg" alt="img"
                                    class="img-fluid w-100">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <div class="card wow fadeInUp" data-wow-delay="0.8s">
                            ...
                            <div class="card-body pb-0 pe-0">
                                <img src="../assets/images/landing/img-demo3.jpg" alt="img"
                                    class="img-fluid w-100">
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-9 position-relative img-webapp-block">
                        <img src="../assets/images/landing/img-element-main-theme-1.png" alt="img"
                            data-img-type=".png" class="img-landing img-fluid"
                            data-img="../assets/images/landing/img-element-main-theme-">
                        <img src="../assets/images/landing/img-element-msg.png" alt="img"
                            class="img-fluid img-msg">
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center mb-4 mb-md-5">
                    <div class="col-auto my-2">
                        <img src="../assets/images/landing/client-01.png" alt="img"
                            class="img-fluid wow fadeInUp" data-wow-delay="0.2s">
                    </div>
                    <div class="col-auto my-2">
                        <img src="../assets/images/landing/client-02.png" alt="img"
                            class="img-fluid wow fadeInUp" data-wow-delay="0.4s">
                    </div>
                    <div class="col-auto my-2">
                        <img src="../assets/images/landing/client-03.png" alt="img"
                            class="img-fluid wow fadeInUp" data-wow-delay="0.6s">
                    </div>
                    <div class="col-auto my-2">
                        <img src="../assets/images/landing/client-04.png" alt="img"
                            class="img-fluid wow fadeInUp" data-wow-delay="0.8s">
                    </div>
                </div>
            </div>
        ...
        <footer class="footer bg-dark text-white">
            <div class="top-footer footer-moke pb-0">
                <img style="clip-path: inset(110px 0 0 0);
    margin-top: -110px;"
